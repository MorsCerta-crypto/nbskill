...
# %% auto #0
__all__ = ['insert_lines', 'replace_lines', 'delete_lines', 'replace_text', 'replace_texts', 'edit_notebook', 'Editor']
...
class Editor:
    ...
    def apply(self, *edits, **kw):
        ...
        return edit_notebook(self.path, list(edits), validate_code=self.validate_code, auto_feedback=self.auto_feedback, **kw)
...
def edit(self: Notebook):
    'Return an Editor bound to this notebook path.'

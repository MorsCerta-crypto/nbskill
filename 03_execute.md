...
still imports it at module import time. Keep `safepyrun` lazy so basic
discovery and non-execution tools remain available without this optional
...
<a
href="https://github.com/MorsCerta-crypto/nbskill/blob/main/nbskill/execute.py#L978"
target="_blank" style="float:right; font-size:smaller">source</a>
...
``` python
def verify_notebook(
    path, up2id:NoneType=None, timeout:int=30, safe:bool=True
):
```
...
<a
href="https://github.com/MorsCerta-crypto/nbskill/blob/main/nbskill/execute.py#L1077"
target="_blank" style="float:right; font-size:smaller">source</a>
...
try:
    ...
    result = exec_nb(str(uncalled), timeout=5, allow_new=True, show_output=False)
    assert any("unused_demo" in warning for warning in result["warnings"])
finally:
...
<a
href="https://github.com/MorsCerta-crypto/nbskill/blob/main/nbskill/execute.py#L1141"
target="_blank" style="float:right; font-size:smaller">source</a>
